...
describe('FilteredList Component', () => {
  ...
  it('renders filtered suggestions with highlighted match', () => {
    ...
    expect(suggestionItems[0].querySelector('.font-bold.text-blue-500')).toHaveTextContent('Retriever');

    expect(suggestionItems[1]).toHaveTextContent('Golden ');
    expect(suggestionItems[1].querySelector('.font-bold.text-blue-500')).toHaveTextContent('Retriever');
  });
